...
namespace Test.Helpers
{
...

    {
        ...
        public static bool csvComparerowcolumnnwise(IWebDriver driver, string sourcecsvfilepath, string sourcecsvfilename, int sourcesrownum,
            int sourceerownum, int sourcescolnum, int sourceecolnum, string destinationcsvfilepath, string destinationcsvfilename,
            int destinationsrownum, int destinationerownum, int destinationscolnum, int destinationecolnum)
        {
            LogHelper.WriteLog( sourcecsvfilepath, "**********************");
