...
namespace Test.Helpers
{
    public class GenericHelper
    {
        ...
        {
            DriverContext.Driver.FindElement(locator).Click();
        ...
        {
          return  DriverContext.Driver.FindElement(By.XPath(xapth));
        }
        //  ************with WAIT **********************************//
        ...
        public static bool SwitchToWindowWithTitle(String title)
        {
            ...
            foreach (String handle in all_windowHandles)
            {
                ...
                if (DriverContext.Driver.Title.Contains(title))
                {
                    break;
                }
            }
        ...
        public static bool MouseHoverToElementbylocator(By locator)
        {
            try
            {
                Thread.Sleep(15000);
                Actions action = new Actions(DriverContext.Driver);
                action.MoveToElement(DriverContext.Driver.FindElement(locator)).Build().Perform();
                Thread.Sleep(15000);
            }
            catch (Exception e)
            {
        ...
        public static bool MouseHoverToElementandClickbylocator(By locator)
        {
            try
            {
                Thread.Sleep(15000);
                Actions action = new Actions(DriverContext.Driver);
                action.MoveToElement(DriverContext.Driver.FindElement(locator)).Click().Build().Perform();
                Thread.Sleep(15000);
            }
            catch (Exception e)
            {
